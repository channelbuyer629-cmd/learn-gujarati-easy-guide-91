          ...
          <TabsContent value="vocabulary">
            <Card>
              ...
              <CardContent className="space-y-4">
                {/* Word Bank Uploader with proper CSV format */}
                <WordBankUploader onSuccess={() => {
                  toast({
                    title: "Success",
                    description: "Word bank content uploaded successfully!"
                  });
                }} />
                ...
                <Button onClick={() => toast({ title: "Feature Coming Soon", description: "Manual word bank creation will be available soon. Please use the CSV upload above with proper format for each content type." })}>
